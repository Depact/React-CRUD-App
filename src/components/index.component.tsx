      ...
      <div className='px-4 py-5 my-5 text-center'>
        ...
        <div className='col-lg-6 mx-auto'>
          ...
          <div className='d-grid gap-2 d-sm-flex justify-content-sm-center'>
            <a type='button' className='btn btn-primary btn-lg px-4 gap-3' href='https://github.com/seakBz/React-TypeScript-CRUD'>
              Go to repo
            </a>

            <Link to='/index' className='btn btn-outline-secondary btn-lg px-4'>
              Index
            </Link>
          </div>
        </div>
